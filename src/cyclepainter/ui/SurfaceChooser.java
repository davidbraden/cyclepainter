 ...
 * @author tim
 */
public class SurfaceChooser extends JPanel implements SurfaceChangeListener {
    ...
    public void setSurface() {
        try {
            ...
            surface.setSurface(curveText.getText(), xText.getText(),
                    yText.getText(), base, sheetBase);
            ...
            System.err
                    .println("Format of base points is a+b*I. Couldn't parse.");
    ...
    public void surfaceChanged(RiemannSurface surf) {
        ...
        baseText.setText(MapleUtils.pointToString(surf.getBasePoint()));
        sheetsText.setText(MapleUtils.pointToString(surf.getSheetsBase()));
