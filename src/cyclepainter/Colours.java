...
public class Colours {
    public static final Color[] SHEET_COLOURS = {
        new Color(0x00,0x00,0xaa), new Color(0x00,0xaa,0x00), 
	new Color(0x00,0xaa,0xaa), new Color(0xaa,0x00,0x00), 
	new Color(0xaa,0x00,0xaa), new Color(0xaa,0x55,0x00), 
	new Color(0x55,0x55,0xff), new Color(0x55,0xff,0x55), 
	new Color(0x55,0xff,0xff), new Color(0xff,0x55,0x55), 
	new Color(0xff,0x44,0xff), new Color(0xff,0xff,0x55), 
	new Color(0x00,0x00,0x00)
    };
    public static final int MAX_COLOUR = SHEET_COLOURS.length - 1;
